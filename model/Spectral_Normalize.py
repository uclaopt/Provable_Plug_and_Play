...
class SpectralNorm(object):
    ...
    def compute_weight(self, module):
        ...
        with torch.no_grad():
            for _ in range(self.n_power_iterations):
                ...
                v = normalize(conv2d(u, weight_mat.permute(1, 0, 2, 3), padding=1), eps=self.eps)
    ...
    @staticmethod
    def apply(module, name, n_power_iterations, dim, eps, batch_size):
        ...
        u = normalize(weight.new_empty(batch_size, C_out, 40, 40).normal_(0, 1), eps=fn.eps)# input size
...
def spectral_norm(module, name='weight', n_power_iterations=1, eps=1e-12, dim=None, batch_size=128):
    ...
    if dim is None:
        if isinstance(module, (torch.nn.ConvTranspose1d,
            ...
            dim = 0
    SpectralNorm.apply(module, name, n_power_iterations, dim, eps, batch_size)
    return module
